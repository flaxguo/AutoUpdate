================================================================================
    MICROSOFT 基础类库： AutoUpdate 项目概述
===============================================================================

应用程序向导已为您创建了此 AutoUpdate 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 AutoUpdate 应用程序的每个文件的内容摘要。
...
AutoUpdate.h
    ...
    CAutoUpdateApp 应用程序类。

AutoUpdate.cpp
    这是包含应用程序
    类 CAutoUpdateApp 的主应用程序源文件。
...
应用程序向导将创建一个对话框类：
AutoUpdateDlg.h、AutoUpdateDlg.cpp - 对话框
    这些文件包含 CAutoUpdateDlg 类。  此类定义
    应用程序主对话框的行为。  此对话框的模板包含在 
    AutoUpdate.rc 中，而此文件可以在 Microsoft Visual C++ 中进行编辑。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 AutoUpdate.pch 的预编译头文件 (PCH)
